...
class Register():
    ...
    def valid_add(self, operation):
        if isinstance(operation.val, Register):
            children = operation.val.get_all_children()
            if self in children:
    ...
    def get_all_children(self):
        ...
        for operation in self.children:
            if isinstance(operation.val, Register):
                ...
                children.append(operation.val.get_all_children())
    ...
    def eval(self):
        ...
        for operation in self.children:
            ...
            sum = symbols[operation.op](sum, operation.eval())
...
def handle_input(istream):
    ...
    for line in istream:
        ...
        run_command(line)
        # if val is not "quit":
        #     output.append(run_command(line))
